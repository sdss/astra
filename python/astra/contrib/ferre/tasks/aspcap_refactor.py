...
class ApStarMixinBase(object):
    ...
    def output_table_name(self):
        raise RuntimeError("this should be defined by the task sub-class")
...
class InitialEstimateOfStellarParametersGivenApStarFileBase(FerreMixin):
    ...
    def output(self):
        ...
        return dict(database=FerreResultProxy(self, table_name=self.output_table_name))
...
class EstimateStellarParametersGivenApStarFileBase(FerreMixin):
    ...
    def output(self):
        ...
        requirements = {
            "database": FerreResultProxy(self, table_name=self.output_table_name),
        ...
        with tqdm(desc="Batching abundance tasks", total=total) as pbar:
            ...
            for task in self.requires().get_batch_tasks():
                ...
                for element in self.elements:
                    ...
                    initial_parameters = { k: flatten(output[sanitise_parameter_names(k)]) for k in label_names }
