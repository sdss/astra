...
from astra.contrib.slam.slam.normalization import normalize_spectrum, normalize_spectra_block
...
def estimate_stellar_labels(
    ...
    for instance, path, spectrum in tqdm(prepare_data(pks), total=total):
        ...
        fluxes_norm, fluxes_cont = normalize_spectra_block(wave_interp, fluxes_resamp, (6147., 8910.), dwave_slam,
                                                            p=p_slam, q=q_slam, ivar_block=ivar_block_slam, eps=eps_slam,
                                                            rsv_frac=rsv_frac_slam, n_jobs=n_jobs_slam,verbose=verbose_slam)
