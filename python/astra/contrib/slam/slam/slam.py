...
class Slam(object):
    ...
    def predict_labels_multi(
        ...
        ** all input should be 2D array or sequential **
        ...
        print(
            "@SLAM: The spectra with fewest pixels unmasked == "
    ...
    def predict_spectra(
        ...
        flux_pred = Parallel(n_jobs=n_jobs, verbose=verbose)(
            delayed(predict_spectrum)(self.svrs, X_pred[i]) for i in range(n_pred)
        )
    ...
    @staticmethod
    def heal_the_world(
        flux, ivar, labels=None, mask_conv=(1, 2), flux_bounds=(1e-3, 1e2), ivar_eps=1e0
    ):
    ...
    def train_test_split(self, test_size=0.1, train_size=0.9, random_state=0):
        ...
        return Slam(self.wave, tr_flux, tr_ivar, tr_label, **self.init_kwargs), (
            test_flux,
            test_ivar,
            test_labels,
        )
