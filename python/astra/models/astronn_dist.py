...
class AstroNNdist(BaseModel, PipelineOutputMixin):
    ...
    L_fakemag_model_err = FloatField(null=True, help_text="Model error in predicted (fake) Ks-band absolute luminosity")
    nn_dist = FloatField(null=True, help_text="NN Heliocentric distance [pc]")
    nn_dist_err = FloatField(null=True, help_text="NN Heliocentric distance error [pc]")
    nn_dist_model_err = FloatField(null=True, help_text="NN Model error in heliocentric distance [pc]")
    nn_parallax = FloatField(null=True, help_text="NN parallax [mas]")
    nn_parallax_err = FloatField(null=True, help_text="NN parallax error [mas]")
    nn_parallax_model_err = FloatField(null=True, help_text="NN Model error in parallax [mas]")
    gdr3_parallax_w_zp = FloatField(null=True, help_text="Gaia DR3 zero-point-corrected parallax [mas]")
    gdr3_parallax_err = FloatField(null=True, help_text="Gaia DR3 parallax error [mas]")
    gdr3_zeropoint = FloatField(null=True, help_text="Gaia DR3 zero-point offset [mas]")
    weighted_parallax = FloatField(null=True, help_text="Weighted parallax [mas]")
    weighted_parallax_err = FloatField(null=True, help_text="Weighted parallax error [mas]")
    weighted_dist = FloatField(null=True, help_text="Weighted distance [pc]")
    weighted_dist_err = FloatField(null=True, help_text="Weighted distance error [pc]")
