...
class ASPCAP(BaseModel, PipelineOutputMixin):
    ...
    #flag_al_h_upper_limit = al_h_flags.flag(2**0, "Upper limit according to X")
    ...
    #flag_c_12_13_upper_limit = c_12_13_flags.flag(2**0, "Upper limit according to X")
    ...
    #flag_ca_h_upper_limit = ca_h_flags.flag(2**0, "Upper limit according to X")
    ...
    #flag_ce_h_upper_limit = ce_h_flags.flag(2**0, "Upper limit according to X")
    ...
    #flag_c_1_h_upper_limit = c_1_h_flags.flag(2**0, "Upper limit according to X")
    ...
    #flag_c_h_upper_limit = c_h_flags.flag(2**0, "Upper limit according to X")
    ...
    #flag_co_h_upper_limit = co_h_flags.flag(2**0, "Upper limit according to X")
    ...
    flag_p_h_upper_limit_t1 = p_h_flags.flag(2**0, "Upper limit according to T1")
    flag_p_h_upper_limit_t2 = p_h_flags.flag(2**1, "Upper limit according to T2")
    flag_p_h_upper_limit_t3 = p_h_flags.flag(2**2, "Upper limit according to T3")
    flag_p_h_upper_limit_t4 = p_h_flags.flag(2**3, "Upper limit according to T4")
    flag_p_h_upper_limit_t5 = p_h_flags.flag(2**4, "Upper limit according to T5")
