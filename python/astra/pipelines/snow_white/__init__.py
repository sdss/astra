...
@task
def snow_white(spectra):
    """
    Classify white dwarf types based on their spectra.
    ...
    #====================find second solution and repeat everything again#==============================================
        ...
        T_true=fitting_scripts.hot_vs_cold(best_T,best_g/100,best_T2,best_g2/100,spectrum.source.plx,spectrum.source.g_mag,emu,wref)
        if T_true==best_T:
...
def wd_stellar_parameters(spectrum):
