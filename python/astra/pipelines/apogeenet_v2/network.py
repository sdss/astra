...
class Network:
    class MetadataNet(nn.Module):
        ...
        def __init__(self):
            ...
            super(Network.MetadataNet, self).__init__()
    ...
    class APOGEENet(nn.Module):
        ...
        def __init__(
            ...
            super(Network.APOGEENet, self).__init__()
            ...
            self.metadata = Network.MetadataNet()
...
@cache
def read_network(network_path, device=None):
