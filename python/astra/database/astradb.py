...
class ThePayneOutput(AstraOutputBaseModel):
    ...
    teff_logg_corr = FloatField()
    teff_v_turb_corr = FloatField()
    teff_c_h_corr = FloatField()
    teff_n_h_corr = FloatField()
    teff_o_h_corr = FloatField()
    teff_na_h_corr = FloatField()
    teff_mg_h_corr = FloatField()
    teff_al_h_corr = FloatField()
    teff_si_h_corr = FloatField()
    teff_p_h_corr = FloatField()
    teff_s_h_corr = FloatField()
    teff_k_h_corr = FloatField()
    teff_ca_h_corr = FloatField()
    teff_ti_h_corr = FloatField()
    teff_v_h_corr = FloatField()
    teff_cr_h_corr = FloatField()
    teff_mn_h_corr = FloatField()
    teff_fe_h_corr = FloatField()
    teff_co_h_corr = FloatField()
    teff_ni_h_corr = FloatField()
    teff_cu_h_corr = FloatField()
    teff_ge_h_corr = FloatField()
    teff_c12_c13_corr = FloatField()
    teff_v_macro_corr = FloatField()
    logg_v_turb_corr = FloatField()
    logg_c_h_corr = FloatField()
    logg_n_h_corr = FloatField()
    logg_o_h_corr = FloatField()
    logg_na_h_corr = FloatField()
    logg_mg_h_corr = FloatField()
    logg_al_h_corr = FloatField()
    logg_si_h_corr = FloatField()
    logg_p_h_corr = FloatField()
    logg_s_h_corr = FloatField()
    logg_k_h_corr = FloatField()
    logg_ca_h_corr = FloatField()
    logg_ti_h_corr = FloatField()
    logg_v_h_corr = FloatField()
    logg_cr_h_corr = FloatField()
    logg_mn_h_corr = FloatField()
    logg_fe_h_corr = FloatField()
    logg_co_h_corr = FloatField()
    logg_ni_h_corr = FloatField()
    logg_cu_h_corr = FloatField()
    logg_ge_h_corr = FloatField()
    logg_c12_c13_corr = FloatField()
    logg_v_macro_corr = FloatField()
    v_turb_c_h_corr = FloatField()
    v_turb_n_h_corr = FloatField()
    v_turb_o_h_corr = FloatField()
    v_turb_na_h_corr = FloatField()
    v_turb_mg_h_corr = FloatField()
    v_turb_al_h_corr = FloatField()
    v_turb_si_h_corr = FloatField()
    v_turb_p_h_corr = FloatField()
    v_turb_s_h_corr = FloatField()
    v_turb_k_h_corr = FloatField()
    v_turb_ca_h_corr = FloatField()
    v_turb_ti_h_corr = FloatField()
    v_turb_v_h_corr = FloatField()
    v_turb_cr_h_corr = FloatField()
    v_turb_mn_h_corr = FloatField()
    v_turb_fe_h_corr = FloatField()
    v_turb_co_h_corr = FloatField()
    v_turb_ni_h_corr = FloatField()
    v_turb_cu_h_corr = FloatField()
    v_turb_ge_h_corr = FloatField()
    v_turb_c12_c13_corr = FloatField()
    v_turb_v_macro_corr = FloatField()
    c_h_n_h_corr = FloatField()
    c_h_o_h_corr = FloatField()
    c_h_na_h_corr = FloatField()
    c_h_mg_h_corr = FloatField()
    c_h_al_h_corr = FloatField()
    c_h_si_h_corr = FloatField()
    c_h_p_h_corr = FloatField()
    c_h_s_h_corr = FloatField()
    c_h_k_h_corr = FloatField()
    c_h_ca_h_corr = FloatField()
    c_h_ti_h_corr = FloatField()
    c_h_v_h_corr = FloatField()
    c_h_cr_h_corr = FloatField()
    c_h_mn_h_corr = FloatField()
    c_h_fe_h_corr = FloatField()
    c_h_co_h_corr = FloatField()
    c_h_ni_h_corr = FloatField()
    c_h_cu_h_corr = FloatField()
    c_h_ge_h_corr = FloatField()
    c_h_c12_c13_corr = FloatField()
    c_h_v_macro_corr = FloatField()
    n_h_o_h_corr = FloatField()
    n_h_na_h_corr = FloatField()
    n_h_mg_h_corr = FloatField()
    n_h_al_h_corr = FloatField()
    n_h_si_h_corr = FloatField()
    n_h_p_h_corr = FloatField()
    n_h_s_h_corr = FloatField()
    n_h_k_h_corr = FloatField()
    n_h_ca_h_corr = FloatField()
    n_h_ti_h_corr = FloatField()
    n_h_v_h_corr = FloatField()
    n_h_cr_h_corr = FloatField()
    n_h_mn_h_corr = FloatField()
    n_h_fe_h_corr = FloatField()
    n_h_co_h_corr = FloatField()
    n_h_ni_h_corr = FloatField()
    n_h_cu_h_corr = FloatField()
    n_h_ge_h_corr = FloatField()
    n_h_c12_c13_corr = FloatField()
    n_h_v_macro_corr = FloatField()
    o_h_na_h_corr = FloatField()
    o_h_mg_h_corr = FloatField()
    o_h_al_h_corr = FloatField()
    o_h_si_h_corr = FloatField()
    o_h_p_h_corr = FloatField()
    o_h_s_h_corr = FloatField()
    o_h_k_h_corr = FloatField()
    o_h_ca_h_corr = FloatField()
    o_h_ti_h_corr = FloatField()
    o_h_v_h_corr = FloatField()
    o_h_cr_h_corr = FloatField()
    o_h_mn_h_corr = FloatField()
    o_h_fe_h_corr = FloatField()
    o_h_co_h_corr = FloatField()
    o_h_ni_h_corr = FloatField()
    o_h_cu_h_corr = FloatField()
    o_h_ge_h_corr = FloatField()
    o_h_c12_c13_corr = FloatField()
    o_h_v_macro_corr = FloatField()
    na_h_mg_h_corr = FloatField()
    na_h_al_h_corr = FloatField()
    na_h_si_h_corr = FloatField()
    na_h_p_h_corr = FloatField()
    na_h_s_h_corr = FloatField()
    na_h_k_h_corr = FloatField()
    na_h_ca_h_corr = FloatField()
    na_h_ti_h_corr = FloatField()
    na_h_v_h_corr = FloatField()
    na_h_cr_h_corr = FloatField()
    na_h_mn_h_corr = FloatField()
    na_h_fe_h_corr = FloatField()
    na_h_co_h_corr = FloatField()
    na_h_ni_h_corr = FloatField()
    na_h_cu_h_corr = FloatField()
    na_h_ge_h_corr = FloatField()
    na_h_c12_c13_corr = FloatField()
    na_h_v_macro_corr = FloatField()
    mg_h_al_h_corr = FloatField()
    mg_h_si_h_corr = FloatField()
    mg_h_p_h_corr = FloatField()
    mg_h_s_h_corr = FloatField()
    mg_h_k_h_corr = FloatField()
    mg_h_ca_h_corr = FloatField()
    mg_h_ti_h_corr = FloatField()
    mg_h_v_h_corr = FloatField()
    mg_h_cr_h_corr = FloatField()
    mg_h_mn_h_corr = FloatField()
    mg_h_fe_h_corr = FloatField()
    mg_h_co_h_corr = FloatField()
    mg_h_ni_h_corr = FloatField()
    mg_h_cu_h_corr = FloatField()
    mg_h_ge_h_corr = FloatField()
    mg_h_c12_c13_corr = FloatField()
    mg_h_v_macro_corr = FloatField()
    al_h_si_h_corr = FloatField()
    al_h_p_h_corr = FloatField()
    al_h_s_h_corr = FloatField()
    al_h_k_h_corr = FloatField()
    al_h_ca_h_corr = FloatField()
    al_h_ti_h_corr = FloatField()
    al_h_v_h_corr = FloatField()
    al_h_cr_h_corr = FloatField()
    al_h_mn_h_corr = FloatField()
    al_h_fe_h_corr = FloatField()
    al_h_co_h_corr = FloatField()
    al_h_ni_h_corr = FloatField()
    al_h_cu_h_corr = FloatField()
    al_h_ge_h_corr = FloatField()
    al_h_c12_c13_corr = FloatField()
    al_h_v_macro_corr = FloatField()
    si_h_p_h_corr = FloatField()
    si_h_s_h_corr = FloatField()
    si_h_k_h_corr = FloatField()
    si_h_ca_h_corr = FloatField()
    si_h_ti_h_corr = FloatField()
    si_h_v_h_corr = FloatField()
    si_h_cr_h_corr = FloatField()
    si_h_mn_h_corr = FloatField()
    si_h_fe_h_corr = FloatField()
    si_h_co_h_corr = FloatField()
    si_h_ni_h_corr = FloatField()
    si_h_cu_h_corr = FloatField()
    si_h_ge_h_corr = FloatField()
    si_h_c12_c13_corr = FloatField()
    si_h_v_macro_corr = FloatField()
    p_h_s_h_corr = FloatField()
    p_h_k_h_corr = FloatField()
    p_h_ca_h_corr = FloatField()
    p_h_ti_h_corr = FloatField()
    p_h_v_h_corr = FloatField()
    p_h_cr_h_corr = FloatField()
    p_h_mn_h_corr = FloatField()
    p_h_fe_h_corr = FloatField()
    p_h_co_h_corr = FloatField()
    p_h_ni_h_corr = FloatField()
    p_h_cu_h_corr = FloatField()
    p_h_ge_h_corr = FloatField()
    p_h_c12_c13_corr = FloatField()
    p_h_v_macro_corr = FloatField()
    s_h_k_h_corr = FloatField()
    s_h_ca_h_corr = FloatField()
    s_h_ti_h_corr = FloatField()
    s_h_v_h_corr = FloatField()
    s_h_cr_h_corr = FloatField()
    s_h_mn_h_corr = FloatField()
    s_h_fe_h_corr = FloatField()
    s_h_co_h_corr = FloatField()
    s_h_ni_h_corr = FloatField()
    s_h_cu_h_corr = FloatField()
    s_h_ge_h_corr = FloatField()
    s_h_c12_c13_corr = FloatField()
    s_h_v_macro_corr = FloatField()
    k_h_ca_h_corr = FloatField()
    k_h_ti_h_corr = FloatField()
    k_h_v_h_corr = FloatField()
    k_h_cr_h_corr = FloatField()
    k_h_mn_h_corr = FloatField()
    k_h_fe_h_corr = FloatField()
    k_h_co_h_corr = FloatField()
    k_h_ni_h_corr = FloatField()
    k_h_cu_h_corr = FloatField()
    k_h_ge_h_corr = FloatField()
    k_h_c12_c13_corr = FloatField()
    k_h_v_macro_corr = FloatField()
    ca_h_ti_h_corr = FloatField()
    ca_h_v_h_corr = FloatField()
    ca_h_cr_h_corr = FloatField()
    ca_h_mn_h_corr = FloatField()
    ca_h_fe_h_corr = FloatField()
    ca_h_co_h_corr = FloatField()
    ca_h_ni_h_corr = FloatField()
    ca_h_cu_h_corr = FloatField()
    ca_h_ge_h_corr = FloatField()
    ca_h_c12_c13_corr = FloatField()
    ca_h_v_macro_corr = FloatField()
    ti_h_v_h_corr = FloatField()
    ti_h_cr_h_corr = FloatField()
    ti_h_mn_h_corr = FloatField()
    ti_h_fe_h_corr = FloatField()
    ti_h_co_h_corr = FloatField()
    ti_h_ni_h_corr = FloatField()
    ti_h_cu_h_corr = FloatField()
    ti_h_ge_h_corr = FloatField()
    ti_h_c12_c13_corr = FloatField()
    ti_h_v_macro_corr = FloatField()
    v_h_cr_h_corr = FloatField()
    v_h_mn_h_corr = FloatField()
    v_h_fe_h_corr = FloatField()
    v_h_co_h_corr = FloatField()
    v_h_ni_h_corr = FloatField()
    v_h_cu_h_corr = FloatField()
    v_h_ge_h_corr = FloatField()
    v_h_c12_c13_corr = FloatField()
    v_h_v_macro_corr = FloatField()
    cr_h_mn_h_corr = FloatField()
    cr_h_fe_h_corr = FloatField()
    cr_h_co_h_corr = FloatField()
    cr_h_ni_h_corr = FloatField()
    cr_h_cu_h_corr = FloatField()
    cr_h_ge_h_corr = FloatField()
    cr_h_c12_c13_corr = FloatField()
    cr_h_v_macro_corr = FloatField()
    mn_h_fe_h_corr = FloatField()
    mn_h_co_h_corr = FloatField()
    mn_h_ni_h_corr = FloatField()
    mn_h_cu_h_corr = FloatField()
    mn_h_ge_h_corr = FloatField()
    mn_h_c12_c13_corr = FloatField()
    mn_h_v_macro_corr = FloatField()
    fe_h_co_h_corr = FloatField()
    fe_h_ni_h_corr = FloatField()
    fe_h_cu_h_corr = FloatField()
    fe_h_ge_h_corr = FloatField()
    fe_h_c12_c13_corr = FloatField()
    fe_h_v_macro_corr = FloatField()
    co_h_ni_h_corr = FloatField()
    co_h_cu_h_corr = FloatField()
    co_h_ge_h_corr = FloatField()
    co_h_c12_c13_corr = FloatField()
    co_h_v_macro_corr = FloatField()
    ni_h_cu_h_corr = FloatField()
    ni_h_ge_h_corr = FloatField()
    ni_h_c12_c13_corr = FloatField()
    ni_h_v_macro_corr = FloatField()
    cu_h_ge_h_corr = FloatField()
    cu_h_c12_c13_corr = FloatField()
    cu_h_v_macro_corr = FloatField()
    ge_h_c12_c13_corr = FloatField()
    ge_h_v_macro_corr = FloatField()
    c12_c13_v_macro_corr = FloatField()
