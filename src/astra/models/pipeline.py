...
class PipelineOutputModel(BaseModel):
    ...
    source_pk = ForeignKeyField(Source, null=True, index=True, lazy_load=False, db_column="source_pk")
    spectrum_pk = ForeignKeyField(Spectrum, index=True, lazy_load=False, db_column="spectrum_pk")
