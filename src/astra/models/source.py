...
class Source(BaseModel):
    ...
    flag_ebv_from_zhang_2023 = ebv_flags.flag(2**0)
    flag_ebv_from_edenhofer_2023 = ebv_flags.flag(2**1)
    flag_ebv_from_sfd = ebv_flags.flag(2**2)
    flag_ebv_from_rjce_glimpse = ebv_flags.flag(2**3)
    flag_ebv_from_rjce_allwise = ebv_flags.flag(2**4)
    flag_ebv_upper_limit = ebv_flags.flag(2**5)
